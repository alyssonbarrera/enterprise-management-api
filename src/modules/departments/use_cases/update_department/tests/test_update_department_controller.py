...
class UpdateDepartmentControllerTest(TestCase):
    ...
    def test_update_department(self):
        ...
        update_response = self.client.put('/v1/departments/update/' + create_response['department']['id'], data_update, content_type='application/json')
    ...
    def test_update_department_if_method_not_allowed(self):
        response = self.client.get('/v1/departments/update/1')
