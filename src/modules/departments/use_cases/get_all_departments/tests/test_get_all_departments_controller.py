...
class GetAllDepartmentsControllerTest(TestCase):
    ...
    def test_get_all_departments(self):
        ...
        self.client.post('/api/departments/create', data, content_type='application/json')

        get_all_response = self.client.get('/api/departments/get/all')
    ...
    def test_get_all_departments_if_method_not_allowed(self):
        response = self.client.post('/api/departments/get/all')
