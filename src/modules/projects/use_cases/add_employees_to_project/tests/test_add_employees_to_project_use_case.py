...
class AddEmployeesToProjectUseCaseTest(TestCase):
    def setUp(self):
        ...
        self.add_employee_to_project_use_case = AddEmployeesToProjectUseCase(
    ...
    def test_add_employee_to_project_with_invalid_project_id(self):
        data_1 = create_department_and_employee(10)
        data_2 = create_department_and_employee(20)
    ...
    def test_add_employee_to_project_with_invalid_employee_id(self):
        ...
        with self.assertRaises(Exception) as context:
            self.add_employee_to_project_use_case.execute(project['id'], employee_id)
    ...
    def test_create_project_with_employee_has_no_hours(self):
        ...
        with self.assertRaises(Exception) as context:
            self.add_employee_to_project_use_case.execute(project['id'], employee_ids)
