...
class Department(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['id'], name='department_id_index'),
...
class Employee(models.Model):
    ...
    projects = models.ManyToManyField('Project', related_name='employee_projects', through='ProjectEmployee')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['id'], name='employee_id_index'),
...
class Project(models.Model):
    ...
    employees = models.ManyToManyField('Employee', related_name='employees_projects', through='ProjectEmployee')
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=['id'], name='project_id_index'),
